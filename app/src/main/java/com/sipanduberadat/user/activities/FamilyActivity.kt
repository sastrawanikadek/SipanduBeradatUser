    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recycler_view.apply {
            ...
            adapter = FamilyRecyclerAdapter(this@FamilyActivity, listOf(
                Krama(1, Banjar(1, DesaAdat(1, Kelurahan(1, Kecamatan(1, Kabupaten(1, Provinsi(1, Negara(1, "Indonesia", true),
                    "Bali", true), "Gianyar", true), "Sukawati", true), "Batuan", true), "Batuan Kaler", (0).toDouble(), (0).toDouble(),
                    ...
                    true, true),
                Krama(2, Banjar(2, DesaAdat(2, Kelurahan(2, Kecamatan(2, Kabupaten(1, Provinsi(1, Negara(1, "Indonesia", true),
                    "Bali", true), "Gianyar", true), "Blahbatuh", true), "Batuh", true), "Pering", (0).toDouble(), (0).toDouble(),
                    ...
                    true, true),
                Krama(3, Banjar(3, DesaAdat(3, Kelurahan(3, Kecamatan(3, Kabupaten(1, Provinsi(1, Negara(1, "Indonesia", true),
                    "Bali", true), "Gianyar", true), "Gianyar", true), "Serongga", true), "Serongga", (0).toDouble(), (0).toDouble(),
                    ...
                    Calendar.getInstance().time, "5104012873660001", "Laki-laki", "Krama Wid",
                    true, true),
                Krama(4, Banjar(4, DesaAdat(4, Kelurahan(4, Kecamatan(4, Kabupaten(1, Provinsi(1, Negara(1, "Indonesia", true),
                    "Bali", true), "Gianyar", true), "Tampaksiring", true), "Pejeng", true), "Pejeng Kelod", (0).toDouble(), (0).toDouble(),
                    ...
                    Calendar.getInstance().time, "5104012873660001", "Laki-laki", "Krama Wid",
                    true, true),
                Krama(5, Banjar(5, DesaAdat(5, Kelurahan(5, Kecamatan(5, Kabupaten(1, Provinsi(1, Negara(1, "Indonesia", true),
                    "Bali", true), "Gianyar", true), "Tegalalang", true), "Kedisan", true), "Kedisan", (0).toDouble(), (0).toDouble(),
