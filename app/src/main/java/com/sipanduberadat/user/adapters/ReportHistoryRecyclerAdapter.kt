...
class ReportHistoryRecyclerAdapter(
    ...
    private val items: List<Pelaporan> = listOf(
        Pelaporan(1, Krama(1, Banjar(1, DesaAdat(1, Kecamatan(1, Kabupaten(1, Provinsi(1, Negara(1, "Indonesia", true), "Bali", true), "Gianyar", true), "Sukawati", true), "Batuan Kaler", (0).toDouble(), (0).toDouble(),
